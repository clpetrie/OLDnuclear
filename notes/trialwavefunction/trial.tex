...
\end{equation}
where the $\Oopij$'s are $\tauij$, $\sigmaij$, and $t_{ij}\tauij$, where $t_{ij} = 3\sigmai \cdot \hat{r}_{ij} \sigmaj \cdot \hat{r}_{ij}-\sigmaij$. \textit{\textcolor{blue}{Why weren't $\sigmaij$ and $t_{ij}$ used in this paper?}}
...
\end{equation}
\textcolor{blue}{\textit{Is this right?}}
