...
\bverb
   ...
   enddo
\end{Verbatim}
Here somekind of correlation is being added, it looks like a correlation related to the tau operators, maybe the tauz operator based on the 6 in \texttt{sx15(:,6,:,i)}. \texttt{sxzupdate} is updating the inverse (\texttt{sxz}) and \texttt{g1bval} and the other two are adding on their respective determinants.
