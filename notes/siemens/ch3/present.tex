...
\begin{itemize}
   ...
   \end{equation}
   \item Let's compare this to the absorbing model. Experiment tells us that $\sigma_{el}$ and $\sigma_{abs}$ should be comparable, where.
   \begin{equation}
...
\frame{\frametitle{Optical Model}
\begin{itemize}
   \item Now you can look at probability density and see how fast things attenuate.
   \begin{equation}
